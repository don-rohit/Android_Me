...
public class LegPartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootview = inflater.inflate(R.layout.fragement_leg_part, container, false);

        // Reference to ImageView
        final ImageView imageView = (ImageView) rootview.findViewById(R.id.leg_part_Image_view);
